...
- **Copilot tab** — plan name, quota reset date, total credits used for the current billing period, a
  credits-by-day chart, and today's credits used. Sourced from `bin/ai-usage-copilot`, which calls GitHub's private
